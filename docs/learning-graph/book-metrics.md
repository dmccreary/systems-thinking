...
| 3 | MicroSims | 13 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 7 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 0 / 0 | Recommended | Chapters with a quiz.md (0 questions total) |
| 6 | Chapter References | 1 / 0 | Recommended | Chapters with references.md (25 references total) |
| 7 | Glossary Terms | 41 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 0 | Recommended | Questions in faq.md |
| 9 | Words | 120,459 | Required | Words across student-facing markdown |
...
| Total Words | 120,459 | 0 | Words in markdown files |
| Links | 336 | 0 | Hyperlinks in markdown format |
| Equivalent Pages | 488 | 6 | Estimated pages (250 words/page + visuals) |
