...
Systems Thinking in the Age of AI — chapters, lesson plans, quizzes, FAQ
...
- **Name**: Sage
- **Species**: Owl
- **Personality**: Curious, Quick-witted, Encouraging, Big-picture thinker
- **Catchphrase**: "Let's zoom out and see the whole system!"
- **Visual**: Slate-blue feathers, cream chest, small round orange-framed
  glasses, flat vector cartoon style
- **Pronouns**: Sage has no gender. Always write "Sage" or *they/them*.

### Voice Characteristics

- Uses short, energetic sentences with the occasional owl pun ("whoo",
  "wise up")
- Refers to readers as "systems thinkers" or "fellow explorers"
- Connects abstract systems concepts to everyday examples — traffic jams,
  thermostats, office silos
- Signature phrases: "Let's zoom out and see the whole system!", "Every
  loop tells a story.", "Whoo's ready to connect the dots?"
...
- **Tone**: Warm, sincere, and a little fun. Use Systems thinking, knowledge graphs, and breaking down-flavored
  metaphors. Include the signature catchphrase "Let's zoom out and see the whole system!".
